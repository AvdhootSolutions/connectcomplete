...
<div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Assign Inquiry To Crew Member </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
              <li class="breadcrumb-item active">Assign Inquiry To Crew Member </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <!-- Default box -->
      <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Assign Inquiry To Crew Member</h3>
              </div>
      ...
      <div class="card card-primary">
              <div class="card-header" style="background-color: #001f3f">
                <h3 class="card-title">List Of Crew Members </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->  
              <div class="card-body">
