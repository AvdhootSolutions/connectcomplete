                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="child_category_name"  class="form-control" id="exampleInputPassword1" placeholder="Sorting Number"  value="{{ isset($data['childcategory']->child_category_name ) ? $data['childcategory']->child_category_name : old('child_category_name') }}" >
                  </div>
