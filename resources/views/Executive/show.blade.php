                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><img src="{{asset('public/executivegovementproff/'.$data['users']->goverment_proff)}}" height="100" width="200"> 
                      </td>
                    </tr>
                    <tr>
                      <td>6.</td>
                      <td>police_verification</td>
                      <td><img src="{{asset('public/executivePoliceproff/'.$data['users']->police_verification)}}" height="100" width="200"> 
                      </td>
                    </tr> 
                    <tr>
                      <td>7.</td>
