  ...
  <!-- Default box -->
      <div class="card card-primary">
              ...
              {!! Form::open(array(
                    ...
                    @csrf
              @else
               {{ Form::model($data['areas'], array('route' => array('areas.update', $data['areas']->id),'role'=>"form" ,'id'=>'productlist-form','enctype'=>'multipart/form-data')) }}
                    {{ method_field('PUT') }}  
                    <input type="hidden" name="action" value="edit">  
                    <input type="hidden" name="id" value="{{$data['areas']->id}}">  
              @endif
