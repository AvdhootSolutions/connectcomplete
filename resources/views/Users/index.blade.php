              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$users->states->name}}</td>
                    
                     
                    <td class="project-actions text-right flex-row"><a style="margin-right: 5px;" href="{{ route('users.edit',$users->id) }}" class="btn btn-xs btn-warning"><i class="fas fa-edit"></i></a>
                      <form action="{{ url('/users', ['id' => $users->id]) }}" method="post" id="delete_form{{$users->id}}">
