        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Individual User</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
          <div class="col-12">
            ...
            <div class="card">
                  ...
                  <!-- /.card-header -->
                  <form action="{{route('searchIndividual')}}" method="post">
                    @csrf
                  <div class="card-body">
                    <div class="row">
                        <div class="col-md-2">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="project-actions text-right flex-row"><a style="margin-right: 5px;" href="{{ route('individualusers.show',$users->id) }}" class="btn btn-xs btn-success"><i class="fas fa-eye"></i></a>
                      <form action="{{ url('/individualusers', ['id' => $users->id]) }}" method="post" id="delete_form{{$users->id}}">
...
$('.status').on('change.bootstrapSwitch', function(e,data) {
    ...
    $.ajax({
        method: 'POST',
        url: '{{ route('individualusers.updateStatus')}}',
        data: {
