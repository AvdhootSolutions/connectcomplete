                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="actual_price" onkeypress="return isNumber(event)" class="form-control" id="exampleInputPassword1" placeholder="Actual Price"  value="{{ isset($data['childcategory']->actual_price ) ? $data['childcategory']->actual_price : old('actual_price') }}" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="tag_percentage" onkeypress="return isNumber(event)" class="form-control" id="exampleInputPassword1" placeholder="Tag %"  value="{{ isset($data['childcategory']->tag_percentage ) ? $data['childcategory']->tag_percentage : old('tag_percentage') }}" >
                    </div>
                    <div class="form-group">
                ...
                <div class="row">
                  <div col class="col-md-12">
                    <label>Short Description</label>
                    <textarea name="short_description" id="content">
                      {{ isset($data['childcategory']->short_description ) ? $data['childcategory']->short_description : old('short_description') }}
                    </textarea>
                  </div>
                </div>
                <div class="row">
                  <div col class="col-md-12">
                    ...
                    <textarea name="long_description" id="long_description">
                      {{ isset($data['childcategory']->long_description ) ? $data['childcategory']->long_description : old('long_description') }}
                    </textarea>
                  </div>
                </div>  
