              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><img src="{{asset('public/childcategory/'.$childcategory->child_category_image)}}" height="70" width="100"></td>
                    <td>{{$childcategory->sorting_number}}</td>
                    <td class="project-actions text-right flex-row"><a style="margin-right: 5px;" href="{{ route('childcategories.edit',$childcategory->id) }}" class="btn btn-xs btn-warning"><i class="fas fa-edit"></i></a>
                      <form action="{{ url('/childcategories', ['id' => $childcategory->id]) }}" method="post" id="delete_form{{$childcategory->id}}">
